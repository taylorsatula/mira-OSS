#!/usr/bin/env python3
"""
Emergency script to generate a magic link for an existing user account.

Usage:
    python scripts/get_magic_link.py <email>
...
def get_magic_link_for_user(email: str) -> tuple[str, str]:
    """
    ...
    try:
        ...
        print(f"✗ Failed to look up user: {e}")
        sys.exit(1)
    ...
    print("\n" + "="*70)
    print("✓ SUCCESS! Your magic link is ready")
    print("="*70)
    print(f"\nEmail:  {email}")
